...
function Category({dropVideoResponse}) {
  ...
  const handleAdd=async()=>{
    ...
    alert("please fill the missing feild")
  }
}
  ...
  return (
    <>
      <div className='d-grid'>
        <button  onClick={handleShow} className='btn btn-info' style={{marginTop:"-50px"}}>ADD CATEGORY</button>
      </div>
...

      {
        allCategories?.length>0?allCategories.map(category=>(
          ...
          <div className="border border-dark rounded p-3 m-3" droppable="true" onDragOver={e=>dragOver(e)} onDrop={e=>videoDropped(e,category?.id)}>
